    ...
    <div class="container-fluid">
            ...
            <div class="col-md-10">
                <div class="container mt-3">
                    ...
                    @endif
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-center">Daftar Category</h5>
                     </br>
                                <div class="row mb-3">
                                <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="col-md-6 d-flex gap-2">
                    <a href="{{ route('categories.create') }}" class="btn text-white" style="background-color: #5d87ff;">Tambah</a>
                    <a href="{{ route('categories.export-pdf') }}" class="btn text-white" style="background-color: #5d87ff;">Export</a>
                </div>

            <!-- Input Pencarian di kanan -->
            <form action="{{ route('categories.index') }}" method="GET" class="d-flex">
    <input type="text" name="search" class="form-control me-2" placeholder="Cari Category" value="{{ request('search') }}">
                        ...
                        <tbody>
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('categories.edit', $category->CategoryID) }}" class="btn btn-warning btn-sm mr-2" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <!-- Tombol Hapus -->
                                            <form action="{{ route('categories.destroy', $category->CategoryID) }}" method="POST" onsubmit="return confirm('Apakah Data Ini Akan Dihapus?');">
                                                @csrf
                                                @method('DELETE')
